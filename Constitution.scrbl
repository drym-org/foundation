...
@item{Projects that are in default are no longer eligible to receive payments from other ABE projects ("attributive revenue") until the issues are resolved (although their entitlement remains unaffected, as before).}
...
@item{The conclusions of the most recent congress take precedence over all previous congresses, and any revisions of previous resolutions (as opposed to fresh resolutions) "backpropagate" as described in the attribution model.}
